<div class="container">
  ...
  <div class="col-md-8 col-sm-12">
    ...
    <form method="POST" action="select-equipamento.php" style="padding:30px;background-color: #eeffee;">

		<input type="text" name="acao" value="pesquisar-equipamentos" hidden="true">
    
    <div class="col-md-12">
		<div class="form-group">
			<label for="nome_equipamento">Nome:</label>
			<input type="text" class="form-control" name="nome_equipamento" id="nome_equipamento">
		</div>
	</div>
	<div class="col-md-12">
		<div class="form-group">
