...
if($_SERVER['REQUEST_METHOD'] == 'GET'){
	...
	switch ($acao) {
		...
		case 'cadastrar-pagamentos':
			$conteudo = 'form-cadastro-pagamento.php';
			break;
		...
		case 'cadastrar-frequencias':
			$conteudo = 'form-cadastro-frequencia.php';
			break;
		...
		case 'listar-pagamentos':
			$conteudo = 'listar-pagamento.php';
			$control->listarPagamento();
			break;
		...
		case 'listar-frequencias':
			$conteudo = 'listar-frequencia.php';
			$control->listarFrequencia();
			break;
			
		case 'listar-logs':
			$conteudo = 'listar-log.php';
			$control->listarLog();
			break;
			
		case 'listar-desempregados':
			$conteudo = 'listar-desempregado.php';
			$control->listarDesempregado();
			break;
