<?php
	...
	$result_usuario = "SELECT * FROM Pagamento WHERE id_pagamento='$id'";
...
<html>
	<head>
		<meta charset="utf-8">
		<title>Formulário de Update de Pagamento</title>
  ...
  <div class="col-md-8 col-sm-12">
    ...
    <form method="POST" action="update-pagamento.php" style="padding:30px;background-color: #eeffee;">

		<input type="hidden" name="id_pagamento" value="<?php echo $row_usuario['id_pagamento']?>">
	...
	<div class="col-md-12">
		<div class="form-group">
			...
			<input type="text" class="form-control" name="situacao" id="situacao" value="<?php echo $row_usuario['situacao']?>" required>
		</div>
	</div>
