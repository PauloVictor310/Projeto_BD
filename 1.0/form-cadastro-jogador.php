<div class="container">
    ...
    <form method="POST" action="cadastro-jogador.php" style="padding:30px;background-color: #eeffee;">
    <div class="col-md-12">
    ...
    <div class="col-md-12">
		<div class="form-group">
			...
			<input type="number" class="form-control" name="numero_camisa" id="numero_camisa" required>
		</div>
	</div>
    <div class="col-md-12">
		<div class="form-group">
