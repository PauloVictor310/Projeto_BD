<?php
	...
	$result_usuario = "SELECT * FROM Jogador WHERE id='$id'";
...
<html>
	<head>
		<meta charset="utf-8">
		<title>Formulário de Update de Jogador</title>
  ...
  <div class="col-md-8 col-sm-12">
    ...
    <form method="POST" action="update-jogador.php" style="padding:30px;background-color: #eeffee;">
    ...
    <div class="col-md-12">
		<div class="form-group">
			...
			<input type="text" class="form-control" name="posicao" id="posicao" value="<?php echo $row_usuario['posicao']?>" required>
		</div>
	</div>
    <div class="col-md-12">
		<div class="form-group">
			<label for="numero_camisa">Número da Camisa:</label>
			<input type="number" class="form-control" name="numero_camisa" id="numero_camisa" value="<?php echo $row_usuario['numero_camisa']?>" required>
		</div>
	</div>
    <div class="col-md-12">
		<div class="form-group">
